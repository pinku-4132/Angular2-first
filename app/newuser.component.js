System.register(['angular2/core', 'angular2/common', 'angular2/router', 'angular2/http', './emailcustomvalidator', './users.service', './user'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, http_1, emailcustomvalidator_1, users_service_1, user_1;
    ...
    return {
        setters:[
            ...
            function (emailcustomvalidator_1_1) {
                emailcustomvalidator_1 = emailcustomvalidator_1_1;
            },
            ...
            UserFormComponent = (function () {
                function UserFormComponent(fb, _router, _routeparams, _userService) {
                    ...
                    this.form = fb.group({
                        ...
                        email: ['', emailcustomvalidator_1.BasicValidators.email],
                        phone: [],
                        address: fb.group({
                            street: [],
                            suite: [],
